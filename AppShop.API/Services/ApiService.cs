...
namespace AppShop.API.Services
{
    public class ApiService : IApiService
    {
        ...
        {
            var section = "CoutriesAPI";
            _configuration = configuration;
            _urlBase = _configuration[$"{section}:urlBase"]!;
            _tokenName = _configuration[$"{section}:tokenName"]!;
            _tokenValue = _configuration[$"{section}:tokenValue"]!;
        }
